...
def extract_records(data: Any) -> list:
    """Extrai registros de uma resposta da API."""
...
def receber_titulo_convertido(dados: Dict[str, Any]) -> str:
    ...
    Args:
        dados: Dados no formato IntegracaoReceberTitulo
...
@mcp.tool()
def receber_cheque(empresa_codigo: Optional[int] = None, dados: Dict[str, Any]) -> str:
    """
    receberCheque - PUT /INTEGRACAO/RECEBER_CHEQUE
    
    Args:
        empresa_codigo: Parâmetro empresaCodigo
        dados: Dados no formato IntegracaoReceberCheque
...
def receber_cartoes(dados: Dict[str, Any]) -> str:
    ...
    Args:
        dados: Dados no formato ReceberCartoesDto
...
def reajustar_estoque_produto_combustivel(dados: Dict[str, Any]) -> str:
    ...
    Args:
        dados: Dados no formato ReajustarProdutoCombustivel
...
def alterar_cliente_grupo(id: str, dados: Dict[str, Any]) -> str:
    ...
    Args:
        id: ID ou código do recurso
        dados: Dados no formato ClienteGrupo
...
def alterar_cliente(id: str, dados: Dict[str, Any]) -> str:
    ...
    Args:
        id: ID ou código do recurso
        dados: Dados no formato IntegracaoClienteCadastro
...
@mcp.tool()
def alterar_produto(id: str, empresa_codigo: Optional[int] = None, dados: Dict[str, Any]) -> str:
    """
    ...
    Args:
        id: ID ou código do recurso
        empresa_codigo: Parâmetro empresaCodigo
        dados: Dados no formato IntegracaoProdutoCadastro
...
@mcp.tool()
def consultar_transferencia_bancaria(empresa_codigo: Optional[int] = None, data_inicial: str, data_final: str, venda_codigo: Optional[int] = None, tipo_inclusao: Optional[int] = None, conta_codigo: Optional[int] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    """
    consultarTransferenciaBancaria - GET /INTEGRACAO/TRANSFERENCIA_BANCARIA
    
    Args:
        empresa_codigo: Parâmetro empresaCodigo
        data_inicial: Parâmetro dataInicial
        data_final: Parâmetro dataFinal
        venda_codigo: Parâmetro vendaCodigo
        tipo_inclusao: Parâmetro tipoInclusao
        conta_codigo: Parâmetro contaCodigo
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if empresa_codigo is not None: params["empresaCodigo"] = empresa_codigo
        if data_inicial is not None: params["dataInicial"] = data_inicial
        if data_final is not None: params["dataFinal"] = data_final
        if venda_codigo is not None: params["vendaCodigo"] = venda_codigo
        if tipo_inclusao is not None: params["tipoInclusao"] = tipo_inclusao
        if conta_codigo is not None: params["contaCodigo"] = conta_codigo
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
def incluir_transferencia(dados: Dict[str, Any]) -> str:
    ...
    Args:
        dados: Dados no formato ParametrosIncluirTransferencia
...
@mcp.tool()
def consultar_titulo_receber(turno: Optional[int] = None, empresa_codigo: Optional[int] = None, data_inicial: str, data_final: str, data_hora_atualizacao: Optional[str] = None, apenas_pendente: Optional[bool] = None, codigo_duplicata: Optional[int] = None, data_filtro: Optional[str] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None, convertido: Optional[bool] = None, venda_codigo: Optional[list] = None) -> str:
    """
    consultarTituloReceber - GET /INTEGRACAO/TITULO_RECEBER
    
    Args:
        turno: Parâmetro turno
        empresa_codigo: Parâmetro empresaCodigo
        data_inicial: Parâmetro dataInicial
        data_final: Parâmetro dataFinal
        data_hora_atualizacao: Parâmetro dataHoraAtualizacao
        apenas_pendente: Parâmetro apenasPendente
        codigo_duplicata: Parâmetro codigoDuplicata
        data_filtro: Parâmetro dataFiltro
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
        convertido: Parâmetro convertido
        venda_codigo: Parâmetro vendaCodigo
    ...
    params = {}
        if turno is not None: params["turno"] = turno
        if empresa_codigo is not None: params["empresaCodigo"] = empresa_codigo
        if data_inicial is not None: params["dataInicial"] = data_inicial
        if data_final is not None: params["dataFinal"] = data_final
        if data_hora_atualizacao is not None: params["dataHoraAtualizacao"] = data_hora_atualizacao
        if apenas_pendente is not None: params["apenasPendente"] = apenas_pendente
        if codigo_duplicata is not None: params["codigoDuplicata"] = codigo_duplicata
        if data_filtro is not None: params["dataFiltro"] = data_filtro
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
        if convertido is not None: params["convertido"] = convertido
        if venda_codigo is not None: params["vendaCodigo"] = venda_codigo
...
def incluir_titulo_receber(dados: Dict[str, Any]) -> str:
    ...
    Args:
        dados: Dados no formato IncluirNotaDto
...
def consultar_titulo_pagar(data_inicial: Optional[str] = None, data_final: Optional[str] = None, data_hora_atualizacao: Optional[str] = None, apenas_pendente: Optional[bool] = None, data_filtro: Optional[str] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None, empresa_codigo: Optional[int] = None, nota_entrada_codigo: Optional[int] = None, titulo_pagar_codigo: Optional[int] = None, fornecedor_codigo: Optional[int] = None, linha_digitavel: Optional[str] = None, autorizado: Optional[bool] = None, tipo_lancamento: Optional[str] = None) -> str:
    ...
    Args:
        ...
        limite: Parâmetro limite
        empresa_codigo: Parâmetro empresaCodigo
        nota_entrada_codigo: Parâmetro notaEntradaCodigo
        titulo_pagar_codigo: Parâmetro tituloPagarCodigo
        fornecedor_codigo: Parâmetro fornecedorCodigo
        linha_digitavel: Parâmetro linhaDigitavel
        autorizado: Parâmetro autorizado
        tipo_lancamento: Parâmetro tipoLancamento
    ...
    params = {}
        ...
        if limite is not None: params["limite"] = limite
        if empresa_codigo is not None: params["empresaCodigo"] = empresa_codigo
        if nota_entrada_codigo is not None: params["notaEntradaCodigo"] = nota_entrada_codigo
        if titulo_pagar_codigo is not None: params["tituloPagarCodigo"] = titulo_pagar_codigo
        if fornecedor_codigo is not None: params["fornecedorCodigo"] = fornecedor_codigo
        if linha_digitavel is not None: params["linhaDigitavel"] = linha_digitavel
        if autorizado is not None: params["autorizado"] = autorizado
        if tipo_lancamento is not None: params["tipoLancamento"] = tipo_lancamento
...
def incluir_titulo_pagar(dados: Dict[str, Any]) -> str:
    ...
    Args:
        dados: Dados no formato IncluirTituloDto
...
def reajustar_produto(dados: Dict[str, Any]) -> str:
    ...
    Args:
        dados: Dados no formato AjusteEstoqueProduto
...
def produto_inventario(dados: Dict[str, Any]) -> str:
    ...
    Args:
        dados: Dados no formato ProdutoInventario
...
def incluir_produto_comissao(dados: Dict[str, Any]) -> str:
    ...
    Args:
        dados: Dados no formato IncluirProdutoComissao
...
def incluir_prazo_tabela_preco_item(id: str, dados: Dict[str, Any]) -> str:
    ...
    Args:
        id: ID ou código do recurso
        dados: Dados no formato IntegracaoPrecoEspecialItem
...
def pedido_compra(dados: Dict[str, Any]) -> str:
    ...
    Args:
        dados: Dados no formato CorpoPedidoCompra
...
def consultar_cliente(cliente_codigo_externo: Optional[str] = None, cliente_codigo: Optional[list] = None, empresa_codigo: Optional[int] = None, retorna_observacoes: Optional[bool] = None, data_hora_atualizacao: Optional[str] = None, frota: Optional[bool] = None, faturamento: Optional[bool] = None, limites_bloqueios: Optional[bool] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        cliente_codigo_externo: Parâmetro clienteCodigoExterno
        cliente_codigo: Parâmetro clienteCodigo
        empresa_codigo: Parâmetro empresaCodigo
        retorna_observacoes: Parâmetro retornaObservacoes
        data_hora_atualizacao: Parâmetro dataHoraAtualizacao
        frota: Parâmetro frota
        faturamento: Parâmetro faturamento
        limites_bloqueios: Parâmetro limitesBloqueios
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if cliente_codigo_externo is not None: params["clienteCodigoExterno"] = cliente_codigo_externo
        if cliente_codigo is not None: params["clienteCodigo"] = cliente_codigo
        if empresa_codigo is not None: params["empresaCodigo"] = empresa_codigo
        if retorna_observacoes is not None: params["retornaObservacoes"] = retorna_observacoes
        if data_hora_atualizacao is not None: params["dataHoraAtualizacao"] = data_hora_atualizacao
        if frota is not None: params["frota"] = frota
        if faturamento is not None: params["faturamento"] = faturamento
        if limites_bloqueios is not None: params["limitesBloqueios"] = limites_bloqueios
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
def consultar_movimento_conta(empresa_codigo: Optional[int] = None, data_inicial: Optional[str] = None, data_final: Optional[str] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None, mostra_saldo: Optional[bool] = None, data_hora_atualizacao: Optional[str] = None, documento_origem_codigo: Optional[int] = None, tipo_documento_origem: Optional[str] = None) -> str:
    ...
    Args:
        ...
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
        mostra_saldo: Parâmetro mostraSaldo
        data_hora_atualizacao: Parâmetro dataHoraAtualizacao
        documento_origem_codigo: Parâmetro documentoOrigemCodigo
        tipo_documento_origem: Parâmetro tipoDocumentoOrigem
    ...
    params = {}
        ...
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
        if mostra_saldo is not None: params["mostraSaldo"] = mostra_saldo
        if data_hora_atualizacao is not None: params["dataHoraAtualizacao"] = data_hora_atualizacao
        if documento_origem_codigo is not None: params["documentoOrigemCodigo"] = documento_origem_codigo
        if tipo_documento_origem is not None: params["tipoDocumentoOrigem"] = tipo_documento_origem
...
def incluir_movimento_conta(dados: Dict[str, Any]) -> str:
    ...
    Args:
        dados: Dados no formato ParametrosIncluirMovimentoConta
...
@mcp.tool()
def consultar_lancamento_contabil(empresa_codigo: Optional[int] = None, data_inicial: str, data_final: str, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None, lote_contabil: Optional[int] = None) -> str:
    """
    ...
    Args:
        ...
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
        lote_contabil: Parâmetro loteContabil
    ...
    params = {}
        ...
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
        if lote_contabil is not None: params["loteContabil"] = lote_contabil
...
def incluir_lancamento_contabil(dados: Dict[str, Any]) -> str:
    ...
    Args:
        dados: Dados no formato ParametrosIncluirLoteContabil
...
@mcp.tool()
def incluir_produto(empresa_codigo: Optional[int] = None, dados: Dict[str, Any]) -> str:
    """
...
def incluir_ofx(dados: Dict[str, Any]) -> str:
    ...
    Args:
        dados: Dados no formato ParamIncluirOfx
...
def consultar_grupo_cliente(grupo_codigo: Optional[int] = None, grupo_codigo_externo: Optional[str] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        grupo_codigo: Parâmetro grupoCodigo
        grupo_codigo_externo: Parâmetro grupoCodigoExterno
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if grupo_codigo is not None: params["grupoCodigo"] = grupo_codigo
        if grupo_codigo_externo is not None: params["grupoCodigoExterno"] = grupo_codigo_externo
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
def vincular_cliente_unidade_negocio(dados: Dict[str, Any]) -> str:
    ...
    Args:
        dados: Dados no formato VincularClienteUnidadeNegocio
...
def incluir_cliente_prazo(codigo_cliente: str, dados: Dict[str, Any]) -> str:
    ...
    Args:
        codigo_cliente: ID ou código do recurso
        dados: Dados no formato IntegracaoListaClientePrazo
...
@mcp.tool()
def consultar_cartao(turno: Optional[int] = None, empresa_codigo: Optional[int] = None, data_inicial: str, data_final: str, apenas_pendente: Optional[bool] = None, data_filtro: Optional[str] = None, data_hora_atualizacao: Optional[str] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None, venda_codigo: Optional[list] = None) -> str:
    """
...
def incluir_cartao(dados: Dict[str, Any]) -> str:
    ...
    Args:
        dados: Dados no formato IncluirAlterarCartaoDto
...
def incluir_brinde(dados: Dict[str, Any]) -> str:
    ...
    Args:
        dados: Dados no formato IntegracaoBrinde
...
def autoriza_pagamento_abastecimento(dados: Dict[str, Any]) -> str:
    ...
    Args:
        dados: Dados no formato AutorizaPagamentoAbastecimento
...
def autorizar_nfe(nota_codigo: str) -> str:
    ...
    Args:
        nota_codigo: ID ou código do recurso
...
def consultar_item_fidelidade(venda_item_voucher_codigo: Optional[int] = None, venda_item_codigo: Optional[list] = None, tipo_integracao_voucher: Optional[str] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        venda_item_voucher_codigo: Parâmetro vendaItemVoucherCodigo
        venda_item_codigo: Parâmetro vendaItemCodigo
        tipo_integracao_voucher: Parâmetro tipoIntegracaoVoucher
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if venda_item_voucher_codigo is not None: params["vendaItemVoucherCodigo"] = venda_item_voucher_codigo
        if venda_item_codigo is not None: params["vendaItemCodigo"] = venda_item_codigo
        if tipo_integracao_voucher is not None: params["tipoIntegracaoVoucher"] = tipo_integracao_voucher
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
def consultar_venda_item(empresa_codigo: Optional[int] = None, usa_produto_lmc: Optional[bool] = None, data_inicial: Optional[str] = None, data_final: Optional[str] = None, tipo_data: Optional[str] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None, venda_codigo: Optional[list] = None) -> str:
    ...
    Args:
        empresa_codigo: Parâmetro empresaCodigo
        usa_produto_lmc: Parâmetro usaProdutoLmc
        data_inicial: Parâmetro dataInicial
        data_final: Parâmetro dataFinal
        tipo_data: Parâmetro tipoData
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
        venda_codigo: Parâmetro vendaCodigo
    ...
    params = {}
        if empresa_codigo is not None: params["empresaCodigo"] = empresa_codigo
        if usa_produto_lmc is not None: params["usaProdutoLmc"] = usa_produto_lmc
        if data_inicial is not None: params["dataInicial"] = data_inicial
        if data_final is not None: params["dataFinal"] = data_final
        if tipo_data is not None: params["tipoData"] = tipo_data
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
        if venda_codigo is not None: params["vendaCodigo"] = venda_codigo
...
def consultar_venda_forma_pagamento(turno: Optional[int] = None, empresa_codigo: Optional[int] = None, data_inicial: Optional[str] = None, data_final: Optional[str] = None, modelo_documento: Optional[str] = None, tipo_data: Optional[str] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None, venda_codigo: Optional[list] = None, situacao: Optional[str] = None, vendas_com_dfe: Optional[bool] = None) -> str:
    ...
    Args:
        ...
        data_inicial: Parâmetro dataInicial
        data_final: Parâmetro dataFinal
        modelo_documento: Parâmetro modeloDocumento
        tipo_data: Parâmetro tipoData
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
        venda_codigo: Parâmetro vendaCodigo
        situacao: Parâmetro situacao
        vendas_com_dfe: Parâmetro vendasComDfe
    ...
    params = {}
        ...
        if data_inicial is not None: params["dataInicial"] = data_inicial
        if data_final is not None: params["dataFinal"] = data_final
        if modelo_documento is not None: params["modeloDocumento"] = modelo_documento
        if tipo_data is not None: params["tipoData"] = tipo_data
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
        if venda_codigo is not None: params["vendaCodigo"] = venda_codigo
        if situacao is not None: params["situacao"] = situacao
        if vendas_com_dfe is not None: params["vendasComDfe"] = vendas_com_dfe
...
def consultar_venda_completa(id_list: str, vendas_com_dfe: Optional[bool] = None) -> str:
    ...
    Args:
        id_list: ID ou código do recurso
        vendas_com_dfe: Parâmetro vendasComDfe
...
@mcp.tool()
def consultar_vale_funcionario(empresa_codigo: Optional[list] = None, data_inicial: str, data_final: str, venda_codigo: Optional[int] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None, quitado: Optional[bool] = None, data_hora_atualizacao: Optional[str] = None, origem: Optional[str] = None) -> str:
    """
    ...
    Args:
        ...
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
        quitado: Parâmetro quitado
        data_hora_atualizacao: Parâmetro dataHoraAtualizacao
        origem: Parâmetro origem
    ...
    params = {}
        ...
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
        if quitado is not None: params["quitado"] = quitado
        if data_hora_atualizacao is not None: params["dataHoraAtualizacao"] = data_hora_atualizacao
        if origem is not None: params["origem"] = origem
...
def troca_preco(data_inicial: str, data_final: str, realizada: Optional[bool] = None, tipo_produto: Optional[str] = None, empresa_codigo: Optional[int] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        data_inicial: Parâmetro dataInicial
        data_final: Parâmetro dataFinal
        realizada: Parâmetro realizada
        tipo_produto: Parâmetro tipoProduto
        empresa_codigo: Parâmetro empresaCodigo
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if data_inicial is not None: params["dataInicial"] = data_inicial
        if data_final is not None: params["dataFinal"] = data_final
        if realizada is not None: params["realizada"] = realizada
        if tipo_produto is not None: params["tipoProduto"] = tipo_produto
        if empresa_codigo is not None: params["empresaCodigo"] = empresa_codigo
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
def consultar_tanque(tanque_codigo: Optional[int] = None, empresa_codigo: Optional[int] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        tanque_codigo: Parâmetro tanqueCodigo
        empresa_codigo: Parâmetro empresaCodigo
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if tanque_codigo is not None: params["tanqueCodigo"] = tanque_codigo
        if empresa_codigo is not None: params["empresaCodigo"] = empresa_codigo
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
def tabela_preco_prazo(tabela_preco_prazo_codigo: Optional[int] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        tabela_preco_prazo_codigo: Parâmetro tabelaPrecoPrazoCodigo
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if tabela_preco_prazo_codigo is not None: params["tabelaPrecoPrazoCodigo"] = tabela_preco_prazo_codigo
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
@mcp.tool()
def consultar_sat(empresa_codigo: Optional[list] = None, data_inicial: str, data_final: str, venda_codigo: Optional[int] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None, quitado: Optional[bool] = None, data_hora_atualizacao: Optional[str] = None, origem: Optional[str] = None) -> str:
    """
...
def sangria_caixa(data_inicial: Optional[str] = None, data_final: Optional[str] = None, data_hora_atualizacao: Optional[str] = None, empresa_codigo: Optional[int] = None, caixa_codigo: Optional[int] = None, funcionario_codigo: Optional[int] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        ...
        data_hora_atualizacao: Parâmetro dataHoraAtualizacao
        empresa_codigo: Parâmetro empresaCodigo
        caixa_codigo: Parâmetro caixaCodigo
        funcionario_codigo: Parâmetro funcionarioCodigo
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        ...
        if data_hora_atualizacao is not None: params["dataHoraAtualizacao"] = data_hora_atualizacao
        if empresa_codigo is not None: params["empresaCodigo"] = empresa_codigo
        if caixa_codigo is not None: params["caixaCodigo"] = caixa_codigo
        if funcionario_codigo is not None: params["funcionarioCodigo"] = funcionario_codigo
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
def consultar_produto_meta(grupo_meta_codigo: Optional[int] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        grupo_meta_codigo: Parâmetro grupoMetaCodigo
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if grupo_meta_codigo is not None: params["grupoMetaCodigo"] = grupo_meta_codigo
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
def consultar_produto_lmc_lmp(codigo_produt_lmc: Optional[int] = None) -> str:
    ...
    Args:
        codigo_produt_lmc: Parâmetro codigoProdutLmc
    ...
    params = {}
        if codigo_produt_lmc is not None: params["codigoProdutLmc"] = codigo_produt_lmc
...
def consultar_produto_estoque(empresa_codigo: int, data_hora: Optional[str] = None, grupo_codigo: Optional[list] = None, produto_codigo: Optional[list] = None) -> str:
    ...
    Args:
        empresa_codigo: Parâmetro empresaCodigo
        data_hora: Parâmetro dataHora
        grupo_codigo: Parâmetro grupoCodigo
        produto_codigo: Parâmetro produtoCodigo
    ...
    params = {}
        if empresa_codigo is not None: params["empresaCodigo"] = empresa_codigo
        if data_hora is not None: params["dataHora"] = data_hora
        if grupo_codigo is not None: params["grupoCodigo"] = grupo_codigo
        if produto_codigo is not None: params["produtoCodigo"] = produto_codigo
...
def consultar_produto(empresa_codigo: Optional[int] = None, produto_codigo: Optional[int] = None, produto_codigo_externo: Optional[str] = None, grupo_codigo: Optional[int] = None, usa_produto_lmc: Optional[bool] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        empresa_codigo: Parâmetro empresaCodigo
        produto_codigo: Parâmetro produtoCodigo
        produto_codigo_externo: Parâmetro produtoCodigoExterno
        grupo_codigo: Parâmetro grupoCodigo
        usa_produto_lmc: Parâmetro usaProdutoLmc
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if empresa_codigo is not None: params["empresaCodigo"] = empresa_codigo
        if produto_codigo is not None: params["produtoCodigo"] = produto_codigo
        if produto_codigo_externo is not None: params["produtoCodigoExterno"] = produto_codigo_externo
        if grupo_codigo is not None: params["grupoCodigo"] = grupo_codigo
        if usa_produto_lmc is not None: params["usaProdutoLmc"] = usa_produto_lmc
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
def consultar_prazos(prazo_codigo: Optional[int] = None, prazo_codigo_externo: Optional[str] = None) -> str:
    ...
    Args:
        prazo_codigo: Parâmetro prazoCodigo
        prazo_codigo_externo: Parâmetro prazoCodigoExterno
    ...
    params = {}
        if prazo_codigo is not None: params["prazoCodigo"] = prazo_codigo
        if prazo_codigo_externo is not None: params["prazoCodigoExterno"] = prazo_codigo_externo
...
def consultar_plano_conta_gerencial(plano_conta_codigo: Optional[int] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        plano_conta_codigo: Parâmetro planoContaCodigo
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if plano_conta_codigo is not None: params["planoContaCodigo"] = plano_conta_codigo
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
def consultar_trr_pedido(empresa_codigo: Optional[int] = None, data_inicial: Optional[str] = None, data_final: Optional[str] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None, pedido_codigo: Optional[int] = None) -> str:
    ...
    Args:
        ...
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
        pedido_codigo: Parâmetro pedidoCodigo
    ...
    params = {}
        ...
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
        if pedido_codigo is not None: params["pedidoCodigo"] = pedido_codigo
...
def consultar_pdv(pdv_referencia: Optional[str] = None, pdv_codigo: Optional[int] = None, empresa_codigo: Optional[int] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        pdv_referencia: Parâmetro pdvReferencia
        pdv_codigo: Parâmetro pdvCodigo
        empresa_codigo: Parâmetro empresaCodigo
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if pdv_referencia is not None: params["pdvReferencia"] = pdv_referencia
        if pdv_codigo is not None: params["pdvCodigo"] = pdv_codigo
        if empresa_codigo is not None: params["empresaCodigo"] = empresa_codigo
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
def consultar_nfse(empresa_codigo: Optional[list] = None, data_inicial: Optional[str] = None, data_final: Optional[str] = None, nfse_codigo: Optional[int] = None, produto_codigo: Optional[int] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        ...
        data_inicial: Parâmetro dataInicial
        data_final: Parâmetro dataFinal
        nfse_codigo: Parâmetro nfseCodigo
        produto_codigo: Parâmetro produtoCodigo
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        ...
        if data_inicial is not None: params["dataInicial"] = data_inicial
        if data_final is not None: params["dataFinal"] = data_final
        if nfse_codigo is not None: params["nfseCodigo"] = nfse_codigo
        if produto_codigo is not None: params["produtoCodigo"] = produto_codigo
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
def consultar_nfse_1(empresa_codigo: Optional[list] = None, data_inicial: Optional[str] = None, data_final: Optional[str] = None, fornecedor_codigo: Optional[int] = None, cliente_codigo: Optional[int] = None, nfse_codigo: Optional[int] = None, rps: Optional[str] = None, tipo_nota: Optional[str] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    params = {}
        ...
        if cliente_codigo is not None: params["clienteCodigo"] = cliente_codigo
        if nfse_codigo is not None: params["nfseCodigo"] = nfse_codigo
        if rps is not None: params["rps"] = rps
        if tipo_nota is not None: params["tipoNota"] = tipo_nota
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
def consultar_nota_saida_item(data_inicial: Optional[str] = None, data_final: Optional[str] = None, empresa_codigo: Optional[int] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None, nota_codigo: Optional[int] = None, nota_item_codigo: Optional[int] = None) -> str:
    ...
    Args:
        ...
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
        nota_codigo: Parâmetro notaCodigo
        nota_item_codigo: Parâmetro notaItemCodigo
    ...
    params = {}
        ...
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
        if nota_codigo is not None: params["notaCodigo"] = nota_codigo
        if nota_item_codigo is not None: params["notaItemCodigo"] = nota_item_codigo
...
def consultar_nota_manifestacao(data_inicial: Optional[str] = None, data_final: Optional[str] = None, compra_codigo: Optional[int] = None, empresa_codigo: Optional[int] = None, manifestacao_codigo: Optional[int] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        data_inicial: Parâmetro dataInicial
        data_final: Parâmetro dataFinal
        compra_codigo: Parâmetro compraCodigo
        empresa_codigo: Parâmetro empresaCodigo
        manifestacao_codigo: Parâmetro manifestacaoCodigo
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if data_inicial is not None: params["dataInicial"] = data_inicial
        if data_final is not None: params["dataFinal"] = data_final
        if compra_codigo is not None: params["compraCodigo"] = compra_codigo
        if empresa_codigo is not None: params["empresaCodigo"] = empresa_codigo
        if manifestacao_codigo is not None: params["manifestacaoCodigo"] = manifestacao_codigo
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
def consultar_nfe_saida(chave_documento: Optional[str] = None, data_inicial: str, data_final: str, empresa_codigo: Optional[int] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None, situacao: Optional[str] = None, numero_documento: Optional[str] = None, serie_documento: Optional[str] = None, nota_codigo: Optional[list] = None, gerou_venda: Optional[bool] = None) -> str:
    ...
    Args:
        ...
        limite: Parâmetro limite
        situacao: Parâmetro situacao
        numero_documento: Parâmetro numeroDocumento
        serie_documento: Parâmetro serieDocumento
        nota_codigo: Parâmetro notaCodigo
        gerou_venda: Parâmetro gerouVenda
    ...
    params = {}
        if chave_documento is not None: params["chaveDocumento"] = chave_documento
        if data_inicial is not None: params["dataInicial"] = data_inicial
        if data_final is not None: params["dataFinal"] = data_final
        if empresa_codigo is not None: params["empresaCodigo"] = empresa_codigo
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
        if situacao is not None: params["situacao"] = situacao
        if numero_documento is not None: params["numeroDocumento"] = numero_documento
        if serie_documento is not None: params["serieDocumento"] = serie_documento
        if nota_codigo is not None: params["notaCodigo"] = nota_codigo
        if gerou_venda is not None: params["gerouVenda"] = gerou_venda
...
@mcp.tool()
def consultar_nfce(empresa_codigo: Optional[list] = None, data_inicial: str, data_final: str, venda_codigo: Optional[int] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None, situacao: Optional[str] = None) -> str:
    """
...
@mcp.tool()
def consultar_relatorio_mapa(empresa_codigo: Optional[list] = None, data_inicial: str, data_final: str, venda_codigo: Optional[int] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None, quitado: Optional[bool] = None, data_hora_atualizacao: Optional[str] = None, origem: Optional[str] = None) -> str:
    """
...
def consultar_fornecedor(retorna_observacoes: Optional[bool] = None, data_hora_atualizacao: Optional[str] = None, fornecedor_codigo_externo: Optional[str] = None, fornecedor_codigo: Optional[int] = None, cnpj_cpf: Optional[str] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        retorna_observacoes: Parâmetro retornaObservacoes
        data_hora_atualizacao: Parâmetro dataHoraAtualizacao
        fornecedor_codigo_externo: Parâmetro fornecedorCodigoExterno
        fornecedor_codigo: Parâmetro fornecedorCodigo
        cnpj_cpf: Parâmetro cnpjCpf
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if retorna_observacoes is not None: params["retornaObservacoes"] = retorna_observacoes
        if data_hora_atualizacao is not None: params["dataHoraAtualizacao"] = data_hora_atualizacao
        if fornecedor_codigo_externo is not None: params["fornecedorCodigoExterno"] = fornecedor_codigo_externo
        if fornecedor_codigo is not None: params["fornecedorCodigo"] = fornecedor_codigo
        if cnpj_cpf is not None: params["cnpjCpf"] = cnpj_cpf
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
def consultar_esclusao_financeiro(empresa_codigo: Optional[int] = None, data_hora_inicial: Optional[str] = None, data_hora_final: Optional[str] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        empresa_codigo: Parâmetro empresaCodigo
        data_hora_inicial: Parâmetro dataHoraInicial
        data_hora_final: Parâmetro dataHoraFinal
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if empresa_codigo is not None: params["empresaCodigo"] = empresa_codigo
        if data_hora_inicial is not None: params["dataHoraInicial"] = data_hora_inicial
        if data_hora_final is not None: params["dataHoraFinal"] = data_hora_final
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
def estoque(empresa_codigo: Optional[int] = None, data_hora_atualizacao: Optional[str] = None, estoque_codigo: Optional[int] = None, estoque_codigo_externo: Optional[str] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        empresa_codigo: Parâmetro empresaCodigo
        data_hora_atualizacao: Parâmetro dataHoraAtualizacao
        estoque_codigo: Parâmetro estoqueCodigo
        estoque_codigo_externo: Parâmetro estoqueCodigoExterno
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if empresa_codigo is not None: params["empresaCodigo"] = empresa_codigo
        if data_hora_atualizacao is not None: params["dataHoraAtualizacao"] = data_hora_atualizacao
        if estoque_codigo is not None: params["estoqueCodigo"] = estoque_codigo
        if estoque_codigo_externo is not None: params["estoqueCodigoExterno"] = estoque_codigo_externo
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
def consultar_empresa(empresa_codigo_externo: Optional[str] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        empresa_codigo_externo: Parâmetro empresaCodigoExterno
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if empresa_codigo_externo is not None: params["empresaCodigoExterno"] = empresa_codigo_externo
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
@mcp.tool()
def consultar_dre(apuracao_caixa: Optional[bool] = None, data_inicial: str, data_final: str, cfop_outras_saidas: Optional[bool] = None, apurar_juros_descontos: Optional[bool] = None, filiais: Optional[list] = None, centro_custo_codigo: Optional[list] = None, apurar_centro_custo_produto: Optional[bool] = None) -> str:
    """
    consultarDre - GET /INTEGRACAO/DRE
    
    Args:
        apuracao_caixa: Parâmetro apuracaoCaixa
        data_inicial: Parâmetro dataInicial
        data_final: Parâmetro dataFinal
        cfop_outras_saidas: Parâmetro cfopOutrasSaidas
        apurar_juros_descontos: Parâmetro apurarJurosDescontos
        filiais: Parâmetro filiais
        centro_custo_codigo: Parâmetro centroCustoCodigo
        apurar_centro_custo_produto: Parâmetro apurarCentroCustoProduto
    ...
    params = {}
        if apuracao_caixa is not None: params["apuracaoCaixa"] = apuracao_caixa
        if data_inicial is not None: params["dataInicial"] = data_inicial
        if data_final is not None: params["dataFinal"] = data_final
        if cfop_outras_saidas is not None: params["cfopOutrasSaidas"] = cfop_outras_saidas
        if apurar_juros_descontos is not None: params["apurarJurosDescontos"] = apurar_juros_descontos
        if filiais is not None: params["filiais"] = filiais
        if centro_custo_codigo is not None: params["centroCustoCodigo"] = centro_custo_codigo
        if apurar_centro_custo_produto is not None: params["apurarCentroCustoProduto"] = apurar_centro_custo_produto
...
def consultar_contagem_estoque(data_contagem: str, contagem_referencia: Optional[int] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        data_contagem: Parâmetro dataContagem
        contagem_referencia: Parâmetro contagemReferencia
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if data_contagem is not None: params["dataContagem"] = data_contagem
        if contagem_referencia is not None: params["contagemReferencia"] = contagem_referencia
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
@mcp.tool()
def consultar_lmc(empresa_codigo: Optional[list] = None, data_inicial: str, data_final: str, venda_codigo: Optional[int] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None, quitado: Optional[bool] = None, data_hora_atualizacao: Optional[str] = None, origem: Optional[str] = None) -> str:
    """
...
@mcp.tool()
def consultar_lmc_1(empresa_codigo: Optional[list] = None, data_inicial: str, data_final: str, venda_codigo: Optional[int] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None, quitado: Optional[bool] = None, data_hora_atualizacao: Optional[str] = None, origem: Optional[str] = None) -> str:
    """
...
def consultar_cartoes_clubgas(nome_tabela: str) -> str:
    ...
    Args:
        nome_tabela: Parâmetro nomeTabela
    ...
    params = {}
        if nome_tabela is not None: params["nomeTabela"] = nome_tabela
...
def consultar_compra(turno: Optional[int] = None, empresa_codigo: Optional[int] = None, data_inicial: Optional[str] = None, data_final: Optional[str] = None, tipo_data: Optional[str] = None, nota_serie: Optional[str] = None, nota_numero: Optional[str] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None, venda_codigo: Optional[list] = None, situacao: Optional[str] = None) -> str:
    ...
    Args:
        ...
        data_final: Parâmetro dataFinal
        tipo_data: Parâmetro tipoData
        nota_serie: Parâmetro notaSerie
        nota_numero: Parâmetro notaNumero
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
        venda_codigo: Parâmetro vendaCodigo
        situacao: Parâmetro situacao
    ...
    params = {}
        ...
        if data_final is not None: params["dataFinal"] = data_final
        if tipo_data is not None: params["tipoData"] = tipo_data
        if nota_serie is not None: params["notaSerie"] = nota_serie
        if nota_numero is not None: params["notaNumero"] = nota_numero
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
        if venda_codigo is not None: params["vendaCodigo"] = venda_codigo
        if situacao is not None: params["situacao"] = situacao
...
def consultar_compra_xml(chave_nfe: str) -> str:
    ...
    Args:
        chave_nfe: ID ou código do recurso
...
def cliente_frota(cliente_codigo_externo: Optional[str] = None, cliente_codigo: Optional[list] = None, motorista_codigo: Optional[list] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        cliente_codigo_externo: Parâmetro clienteCodigoExterno
        cliente_codigo: Parâmetro clienteCodigo
        motorista_codigo: Parâmetro motoristaCodigo
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if cliente_codigo_externo is not None: params["clienteCodigoExterno"] = cliente_codigo_externo
        if cliente_codigo is not None: params["clienteCodigo"] = cliente_codigo
        if motorista_codigo is not None: params["motoristaCodigo"] = motorista_codigo
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
@mcp.tool()
def consultar_cheque_pagar(empresa_codigo: Optional[int] = None, data_inicial: str, data_final: str, tipo_data: str, situacao: Optional[str] = None, cheque_troco: Optional[bool] = None, cheque_codigo: Optional[int] = None, conta_codigo: Optional[int] = None, caixa_codigo: Optional[int] = None, tipo_inclusao: Optional[str] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    """
    ...
    Args:
        ...
        tipo_data: Parâmetro tipoData
        situacao: Parâmetro situacao
        cheque_troco: Parâmetro chequeTroco
        cheque_codigo: Parâmetro chequeCodigo
        conta_codigo: Parâmetro contaCodigo
        caixa_codigo: Parâmetro caixaCodigo
        tipo_inclusao: Parâmetro tipoInclusao
        ultimo_codigo: Parâmetro ultimoCodigo
    ...
    params = {}
        ...
        if tipo_data is not None: params["tipoData"] = tipo_data
        if situacao is not None: params["situacao"] = situacao
        if cheque_troco is not None: params["chequeTroco"] = cheque_troco
        if cheque_codigo is not None: params["chequeCodigo"] = cheque_codigo
        if conta_codigo is not None: params["contaCodigo"] = conta_codigo
        if caixa_codigo is not None: params["caixaCodigo"] = caixa_codigo
        if tipo_inclusao is not None: params["tipoInclusao"] = tipo_inclusao
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
...
@mcp.tool()
def consultar_cheque(turno: Optional[int] = None, empresa_codigo: Optional[int] = None, data_inicial: str, data_final: str, apenas_pendente: Optional[bool] = None, data_filtro: Optional[str] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None, data_hora_atualizacao: Optional[str] = None, venda_codigo: Optional[list] = None) -> str:
    """
...
def consultar_centro_custo(centro_custo_codigo_externo: Optional[str] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        centro_custo_codigo_externo: Parâmetro centroCustoCodigoExterno
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if centro_custo_codigo_externo is not None: params["centroCustoCodigoExterno"] = centro_custo_codigo_externo
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
@mcp.tool()
def consultar_pisconfins_1(empresa_codigo: Optional[list] = None, data_inicial: str, data_final: str, venda_codigo: Optional[int] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None, quitado: Optional[bool] = None, data_hora_atualizacao: Optional[str] = None, origem: Optional[str] = None) -> str:
    """
...
@mcp.tool()
def consultar_cartao_pagar(empresa_codigo: Optional[int] = None, data_inicial: str, data_final: str, tipo_data: str, cartao_compra_codigo: Optional[int] = None, situacao: Optional[str] = None, autorizacao: Optional[str] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    """
    ...
    Args:
        ...
        data_final: Parâmetro dataFinal
        tipo_data: Parâmetro tipoData
        cartao_compra_codigo: Parâmetro cartaoCompraCodigo
        situacao: Parâmetro situacao
        autorizacao: Parâmetro autorizacao
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        ...
        if data_final is not None: params["dataFinal"] = data_final
        if tipo_data is not None: params["tipoData"] = tipo_data
        if cartao_compra_codigo is not None: params["cartaoCompraCodigo"] = cartao_compra_codigo
        if situacao is not None: params["situacao"] = situacao
        if autorizacao is not None: params["autorizacao"] = autorizacao
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
def consultar_caixa(data_inicial: str, data_final: str, turno: Optional[int] = None, empresa_codigo: Optional[int] = None, individual: Optional[bool] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        ...
        turno: Parâmetro turno
        empresa_codigo: Parâmetro empresaCodigo
        individual: Parâmetro individual
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        ...
        if turno is not None: params["turno"] = turno
        if empresa_codigo is not None: params["empresaCodigo"] = empresa_codigo
        if individual is not None: params["individual"] = individual
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
def consultar_bomba(bomba_codigo: Optional[int] = None, empresa_codigo: Optional[int] = None) -> str:
    ...
    Args:
        bomba_codigo: Parâmetro bombaCodigo
        empresa_codigo: Parâmetro empresaCodigo
    ...
    params = {}
        if bomba_codigo is not None: params["bombaCodigo"] = bomba_codigo
        if empresa_codigo is not None: params["empresaCodigo"] = empresa_codigo
...
def consultar_bico(bico_codigo: Optional[int] = None, empresa_codigo: Optional[int] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        bico_codigo: Parâmetro bicoCodigo
        empresa_codigo: Parâmetro empresaCodigo
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if bico_codigo is not None: params["bicoCodigo"] = bico_codigo
        if empresa_codigo is not None: params["empresaCodigo"] = empresa_codigo
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
def aprix_movimento(data_inicial: str, data_final: str) -> str:
    ...
    Args:
        data_inicial: Parâmetro DATA_INICIAL
        data_final: Parâmetro DATA_FINAL
    ...
    params = {}
        if data_inicial is not None: params["DATA_INICIAL"] = data_inicial
        if data_final is not None: params["DATA_FINAL"] = data_final
...
def consultar_administradora(administradora_codigo: Optional[int] = None, empresa_codigo: Optional[int] = None, administradora_codigo_externo: Optional[str] = None, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    ...
    Args:
        administradora_codigo: Parâmetro administradoraCodigo
        empresa_codigo: Parâmetro empresaCodigo
        administradora_codigo_externo: Parâmetro administradoraCodigoExterno
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if administradora_codigo is not None: params["administradoraCodigo"] = administradora_codigo
        if empresa_codigo is not None: params["empresaCodigo"] = empresa_codigo
        if administradora_codigo_externo is not None: params["administradoraCodigoExterno"] = administradora_codigo_externo
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
@mcp.tool()
def consultar_adiantamento_fornecedor(fornecedor_codigo: Optional[int] = None, empresa_codigo: Optional[int] = None, tipo_adiantamento: Optional[str] = None, data_inicial: str, data_final: str, ultimo_codigo: Optional[int] = None, limite: Optional[int] = None) -> str:
    """
    ...
    Args:
        fornecedor_codigo: Parâmetro fornecedorCodigo
        empresa_codigo: Parâmetro empresaCodigo
        tipo_adiantamento: Parâmetro tipoAdiantamento
        data_inicial: Parâmetro dataInicial
        data_final: Parâmetro dataFinal
        ultimo_codigo: Parâmetro ultimoCodigo
        limite: Parâmetro limite
    ...
    params = {}
        if fornecedor_codigo is not None: params["fornecedorCodigo"] = fornecedor_codigo
        if empresa_codigo is not None: params["empresaCodigo"] = empresa_codigo
        if tipo_adiantamento is not None: params["tipoAdiantamento"] = tipo_adiantamento
        if data_inicial is not None: params["dataInicial"] = data_inicial
        if data_final is not None: params["dataFinal"] = data_final
        if ultimo_codigo is not None: params["ultimoCodigo"] = ultimo_codigo
        if limite is not None: params["limite"] = limite
...
def receber_titulo_cartao(id: str, dados: Dict[str, Any]) -> str:
    ...
    Args:
        id: ID ou código do recurso
        dados: Dados no formato IntegracaoReceberTituloCartao
...
def incluir_pedido(dados: Dict[str, Any]) -> str:
    ...
    Args:
        dados: Dados no formato IntegracaoPedidoCombustivelPedido
...
def pedido_faturar(id: str, dados: Dict[str, Any]) -> str:
    ...
    Args:
        id: ID ou código do recurso
        dados: Dados no formato IntegracaoPedidoCombustivelFaturar
...
def pedido_status(pedidos: Optional[list] = None) -> str:
    ...
    params = {}
        if pedidos is not None: params["pedidos"] = pedidos
...
@mcp.tool()
def vendas_periodo(cupom_cancelado: bool, ordenacao_por: str, agrupamento_por: Optional[str] = None, prazo: Optional[list] = None, turno: Optional[list] = None, hora_acompanha_data: Optional[bool] = None, data_inicial: str, data_final: str, hora_inicial: Optional[str] = None, hora_final: Optional[str] = None, grupo_produto: Optional[list] = None, ecf: Optional[list] = None, funcionario: Optional[list] = None, produto: Optional[list] = None, cliente: Optional[int] = None, pdv_caixa: Optional[list] = None, tipo_produto: Optional[list] = None, filial: Optional[list] = None, estoque: Optional[list] = None, tipo_venda: Optional[str] = None, tipo_data: str, apresenta_preco_medio: Optional[bool] = None, grupo_cliente: Optional[list] = None, consolidar: Optional[bool] = None, sub_grupo_produto_nivel1: Optional[list] = None, sub_grupo_produto_nivel2: Optional[list] = None, sub_grupo_produto_nivel3: Optional[list] = None, agrupar_totalizadores: Optional[str] = None, depto_selcon: Optional[str] = None, pdv_gerou_venda: Optional[list] = None, centro_custo: Optional[list] = None) -> str:
    """
    vendasPeriodo - GET /INTEGRACAO/RELATORIO/VENDA_PERIODO
    
    Args:
        cupom_cancelado: Parâmetro cupomCancelado
        ordenacao_por: Parâmetro ordenacaoPor
        agrupamento_por: Parâmetro agrupamentoPor
        prazo: Parâmetro prazo
        turno: Parâmetro turno
        hora_acompanha_data: Parâmetro horaAcompanhaData
        data_inicial: Parâmetro dataInicial
        data_final: Parâmetro dataFinal
        hora_inicial: Parâmetro horaInicial
        hora_final: Parâmetro horaFinal
        grupo_produto: Parâmetro grupoProduto
        ecf: Parâmetro ecf
        funcionario: Parâmetro funcionario
        produto: Parâmetro produto
        cliente: Parâmetro cliente
        pdv_caixa: Parâmetro pdvCaixa
        tipo_produto: Parâmetro tipoProduto
        filial: Parâmetro filial
        estoque: Parâmetro estoque
        tipo_venda: Parâmetro tipoVenda
        tipo_data: Parâmetro tipoData
        apresenta_preco_medio: Parâmetro apresentaPrecoMedio
        grupo_cliente: Parâmetro grupoCliente
        consolidar: Parâmetro consolidar
        sub_grupo_produto_nivel1: Parâmetro subGrupoProdutoNivel1
        sub_grupo_produto_nivel2: Parâmetro subGrupoProdutoNivel2
        sub_grupo_produto_nivel3: Parâmetro subGrupoProdutoNivel3
        agrupar_totalizadores: Parâmetro agruparTotalizadores
        depto_selcon: Parâmetro deptoSelcon
        pdv_gerou_venda: Parâmetro pdvGerouVenda
        centro_custo: Parâmetro centroCusto
    ...
    params = {}
        if cupom_cancelado is not None: params["cupomCancelado"] = cupom_cancelado
        if ordenacao_por is not None: params["ordenacaoPor"] = ordenacao_por
        if agrupamento_por is not None: params["agrupamentoPor"] = agrupamento_por
        if prazo is not None: params["prazo"] = prazo
        if turno is not None: params["turno"] = turno
        if hora_acompanha_data is not None: params["horaAcompanhaData"] = hora_acompanha_data
        if data_inicial is not None: params["dataInicial"] = data_inicial
        if data_final is not None: params["dataFinal"] = data_final
        if hora_inicial is not None: params["horaInicial"] = hora_inicial
        if hora_final is not None: params["horaFinal"] = hora_final
        if grupo_produto is not None: params["grupoProduto"] = grupo_produto
        if ecf is not None: params["ecf"] = ecf
        if funcionario is not None: params["funcionario"] = funcionario
        if produto is not None: params["produto"] = produto
        if cliente is not None: params["cliente"] = cliente
        if pdv_caixa is not None: params["pdvCaixa"] = pdv_caixa
        if tipo_produto is not None: params["tipoProduto"] = tipo_produto
        if filial is not None: params["filial"] = filial
        if estoque is not None: params["estoque"] = estoque
        if tipo_venda is not None: params["tipoVenda"] = tipo_venda
        if tipo_data is not None: params["tipoData"] = tipo_data
        if apresenta_preco_medio is not None: params["apresentaPrecoMedio"] = apresenta_preco_medio
        if grupo_cliente is not None: params["grupoCliente"] = grupo_cliente
        if consolidar is not None: params["consolidar"] = consolidar
        if sub_grupo_produto_nivel1 is not None: params["subGrupoProdutoNivel1"] = sub_grupo_produto_nivel1
        if sub_grupo_produto_nivel2 is not None: params["subGrupoProdutoNivel2"] = sub_grupo_produto_nivel2
        if sub_grupo_produto_nivel3 is not None: params["subGrupoProdutoNivel3"] = sub_grupo_produto_nivel3
        if agrupar_totalizadores is not None: params["agruparTotalizadores"] = agrupar_totalizadores
        if depto_selcon is not None: params["deptoSelcon"] = depto_selcon
        if pdv_gerou_venda is not None: params["pdvGerouVenda"] = pdv_gerou_venda
        if centro_custo is not None: params["centroCusto"] = centro_custo
...
def relatorio_personalizado(relatorio_codigo: str, cliente: Optional[list] = None, data_inicial: Optional[str] = None, data_final: Optional[str] = None, caixa: Optional[int] = None, funcionario: Optional[list] = None, grupo_produto: Optional[list] = None, administradora: Optional[list] = None, situacao_receber: Optional[str] = None, filial: Optional[list] = None, produto: Optional[list] = None, distribuidora: Optional[str] = None, modelo_documento_fiscal: Optional[list] = None, plano_conta: Optional[int] = None, intermediador: Optional[list] = None, data_posicao: Optional[str] = None, nota: Optional[str] = None, situacao_trr: Optional[list] = None, sub_grupo_produto: Optional[list] = None, estoque: Optional[list] = None, centro_custo: Optional[list] = None, fidelidade: Optional[int] = None, tipo_premiacao: Optional[str] = None, situacao_caixa: Optional[str] = None, filial_origem: Optional[int] = None, tipo_reajuste: Optional[list] = None, saldo_inicial: Optional[float] = None, placa: Optional[str] = None, cupom: Optional[str] = None, fornecedor: Optional[list] = None, titulo: Optional[str] = None, remessa: Optional[str] = None, conta: Optional[list] = None, grupo_cliente: Optional[list] = None, motorista: Optional[list] = None, veiculo: Optional[list] = None, prazo: Optional[list] = None, centro_custo_cliente: Optional[list] = None, cfop: Optional[list] = None, tipo_filtro: Optional[str] = None, tipo_operacao: Optional[str] = None, valor1_comparador: Optional[float] = None, valor2_comparador: Optional[float] = None) -> str:
    ...
    Args:
        relatorio_codigo: ID ou código do recurso
        cliente: Parâmetro cliente
        data_inicial: Parâmetro dataInicial
        data_final: Parâmetro dataFinal
        caixa: Parâmetro caixa
        funcionario: Parâmetro funcionario
        grupo_produto: Parâmetro grupoProduto
        administradora: Parâmetro administradora
        situacao_receber: Parâmetro situacaoReceber
        filial: Parâmetro filial
        produto: Parâmetro produto
        distribuidora: Parâmetro distribuidora
        modelo_documento_fiscal: Parâmetro modeloDocumentoFiscal
        plano_conta: Parâmetro planoConta
        intermediador: Parâmetro intermediador
        data_posicao: Parâmetro dataPosicao
        nota: Parâmetro nota
        situacao_trr: Parâmetro situacaoTrr
        sub_grupo_produto: Parâmetro subGrupoProduto
        estoque: Parâmetro estoque
        centro_custo: Parâmetro centroCusto
        fidelidade: Parâmetro fidelidade
        tipo_premiacao: Parâmetro tipoPremiacao
        situacao_caixa: Parâmetro situacaoCaixa
        filial_origem: Parâmetro filialOrigem
        tipo_reajuste: Parâmetro tipoReajuste
        saldo_inicial: Parâmetro saldoInicial
        placa: Parâmetro placa
        cupom: Parâmetro cupom
        fornecedor: Parâmetro fornecedor
        titulo: Parâmetro titulo
        remessa: Parâmetro remessa
        conta: Parâmetro conta
        grupo_cliente: Parâmetro grupoCliente
        motorista: Parâmetro motorista
        veiculo: Parâmetro veiculo
        prazo: Parâmetro prazo
        centro_custo_cliente: Parâmetro centroCustoCliente
        cfop: Parâmetro cfop
        tipo_filtro: Parâmetro tipoFiltro
        tipo_operacao: Parâmetro tipoOperacao
        valor1_comparador: Parâmetro valor1Comparador
        valor2_comparador: Parâmetro valor2Comparador
    ...
    params = {}
        ...
        if data_inicial is not None: params["dataInicial"] = data_inicial
        if data_final is not None: params["dataFinal"] = data_final
        if caixa is not None: params["caixa"] = caixa
        if funcionario is not None: params["funcionario"] = funcionario
        if grupo_produto is not None: params["grupoProduto"] = grupo_produto
        if administradora is not None: params["administradora"] = administradora
        if situacao_receber is not None: params["situacaoReceber"] = situacao_receber
        if filial is not None: params["filial"] = filial
        if produto is not None: params["produto"] = produto
        if distribuidora is not None: params["distribuidora"] = distribuidora
        if modelo_documento_fiscal is not None: params["modeloDocumentoFiscal"] = modelo_documento_fiscal
        if plano_conta is not None: params["planoConta"] = plano_conta
        if intermediador is not None: params["intermediador"] = intermediador
        if data_posicao is not None: params["dataPosicao"] = data_posicao
        if nota is not None: params["nota"] = nota
        if situacao_trr is not None: params["situacaoTrr"] = situacao_trr
        if sub_grupo_produto is not None: params["subGrupoProduto"] = sub_grupo_produto
        if estoque is not None: params["estoque"] = estoque
        if centro_custo is not None: params["centroCusto"] = centro_custo
        if fidelidade is not None: params["fidelidade"] = fidelidade
        if tipo_premiacao is not None: params["tipoPremiacao"] = tipo_premiacao
        if situacao_caixa is not None: params["situacaoCaixa"] = situacao_caixa
        if filial_origem is not None: params["filialOrigem"] = filial_origem
        if tipo_reajuste is not None: params["tipoReajuste"] = tipo_reajuste
        if saldo_inicial is not None: params["saldoInicial"] = saldo_inicial
        if placa is not None: params["placa"] = placa
        if cupom is not None: params["cupom"] = cupom
        if fornecedor is not None: params["fornecedor"] = fornecedor
        if titulo is not None: params["titulo"] = titulo
        if remessa is not None: params["remessa"] = remessa
        if conta is not None: params["conta"] = conta
        if grupo_cliente is not None: params["grupoCliente"] = grupo_cliente
        if motorista is not None: params["motorista"] = motorista
        if veiculo is not None: params["veiculo"] = veiculo
        if prazo is not None: params["prazo"] = prazo
        if centro_custo_cliente is not None: params["centroCustoCliente"] = centro_custo_cliente
        if cfop is not None: params["cfop"] = cfop
        if tipo_filtro is not None: params["tipoFiltro"] = tipo_filtro
        if tipo_operacao is not None: params["tipoOperacao"] = tipo_operacao
        if valor1_comparador is not None: params["valor1Comparador"] = valor1_comparador
        if valor2_comparador is not None: params["valor2Comparador"] = valor2_comparador
...
def produtividade_funcionario(tipo_relatorio: str, tipo_data: Optional[str] = None, funcionario: Optional[int] = None, produto: Optional[int] = None, caixa: Optional[list] = None, data_inicial: Optional[str] = None, data_final: Optional[str] = None, ordenacao: Optional[str] = None, referencia_funcionario: Optional[str] = None, grupo_produto: Optional[list] = None, sub_grupo_produto: Optional[list] = None, pdv: Optional[list] = None, funcoes: Optional[list] = None, tipo_filtro: Optional[str] = None, intervalo_filtro: Optional[str] = None, valor_inicial_filtro: Optional[float] = None, valor_final_filtro: Optional[float] = None, calculo_ticket_medio: Optional[str] = None, agrupamento: Optional[str] = None, filial: Optional[list] = None, comissao: Optional[str] = None, detalha_totalizador_por_grupo: Optional[bool] = None, cliente: Optional[list] = None, grupo_cliente: Optional[list] = None) -> str:
    ...
    Args:
        tipo_relatorio: Parâmetro tipoRelatorio
        tipo_data: Parâmetro tipoData
        funcionario: Parâmetro funcionario
        produto: Parâmetro produto
        caixa: Parâmetro caixa
        data_inicial: Parâmetro dataInicial
        data_final: Parâmetro dataFinal
        ordenacao: Parâmetro ordenacao
        referencia_funcionario: Parâmetro referenciaFuncionario
        grupo_produto: Parâmetro grupoProduto
        sub_grupo_produto: Parâmetro subGrupoProduto
        pdv: Parâmetro pdv
        funcoes: Parâmetro funcoes
        tipo_filtro: Parâmetro tipoFiltro
        intervalo_filtro: Parâmetro intervaloFiltro
        valor_inicial_filtro: Parâmetro valorInicialFiltro
        valor_final_filtro: Parâmetro valorFinalFiltro
        calculo_ticket_medio: Parâmetro calculoTicketMedio
        agrupamento: Parâmetro agrupamento
        filial: Parâmetro filial
        comissao: Parâmetro comissao
        detalha_totalizador_por_grupo: Parâmetro detalhaTotalizadorPorGrupo
        cliente: Parâmetro cliente
        grupo_cliente: Parâmetro grupoCliente
    ...
    params = {}
        if tipo_relatorio is not None: params["tipoRelatorio"] = tipo_relatorio
        if tipo_data is not None: params["tipoData"] = tipo_data
        if funcionario is not None: params["funcionario"] = funcionario
        if produto is not None: params["produto"] = produto
        if caixa is not None: params["caixa"] = caixa
        if data_inicial is not None: params["dataInicial"] = data_inicial
        if data_final is not None: params["dataFinal"] = data_final
        if ordenacao is not None: params["ordenacao"] = ordenacao
        if referencia_funcionario is not None: params["referenciaFuncionario"] = referencia_funcionario
        if grupo_produto is not None: params["grupoProduto"] = grupo_produto
        if sub_grupo_produto is not None: params["subGrupoProduto"] = sub_grupo_produto
        if pdv is not None: params["pdv"] = pdv
        if funcoes is not None: params["funcoes"] = funcoes
        if tipo_filtro is not None: params["tipoFiltro"] = tipo_filtro
        if intervalo_filtro is not None: params["intervaloFiltro"] = intervalo_filtro
        if valor_inicial_filtro is not None: params["valorInicialFiltro"] = valor_inicial_filtro
        if valor_final_filtro is not None: params["valorFinalFiltro"] = valor_final_filtro
        if calculo_ticket_medio is not None: params["calculoTicketMedio"] = calculo_ticket_medio
        if agrupamento is not None: params["agrupamento"] = agrupamento
        if filial is not None: params["filial"] = filial
        if comissao is not None: params["comissao"] = comissao
        if detalha_totalizador_por_grupo is not None: params["detalhaTotalizadorPorGrupo"] = detalha_totalizador_por_grupo
        if cliente is not None: params["cliente"] = cliente
        if grupo_cliente is not None: params["grupoCliente"] = grupo_cliente
...
def mapa_desempenho(data_inicial: str, data_final: str, funcionario: Optional[list] = None, grupo_produto: Optional[list] = None, sub_grupo_produto: Optional[list] = None, produto: Optional[int] = None, usa_dado_premiacao: Optional[bool] = None, base_comissao: Optional[str] = None, referencia_funcionario: Optional[str] = None, tipo_relatorio: Optional[str] = None, ordenacao: Optional[str] = None, pdv: Optional[list] = None, premiacao_baseada_historico: Optional[bool] = None, apenas_comissionado: Optional[bool] = None, hora_inicial: Optional[str] = None, hora_final: Optional[str] = None, cliente: Optional[int] = None, apuracao: Optional[str] = None, filial: Optional[list] = None) -> str:
    ...
    Args:
        ...
        sub_grupo_produto: Parâmetro subGrupoProduto
        produto: Parâmetro produto
        usa_dado_premiacao: Parâmetro usaDadoPremiacao
        base_comissao: Parâmetro baseComissao
        referencia_funcionario: Parâmetro referenciaFuncionario
        tipo_relatorio: Parâmetro tipoRelatorio
        ordenacao: Parâmetro ordenacao
        pdv: Parâmetro pdv
        premiacao_baseada_historico: Parâmetro premiacaoBaseadaHistorico
        apenas_comissionado: Parâmetro apenasComissionado
        hora_inicial: Parâmetro horaInicial
        hora_final: Parâmetro horaFinal
        cliente: Parâmetro cliente
        apuracao: Parâmetro apuracao
        filial: Parâmetro filial
    ...
    params = {}
        ...
        if sub_grupo_produto is not None: params["subGrupoProduto"] = sub_grupo_produto
        if produto is not None: params["produto"] = produto
        if usa_dado_premiacao is not None: params["usaDadoPremiacao"] = usa_dado_premiacao
        if base_comissao is not None: params["baseComissao"] = base_comissao
        if referencia_funcionario is not None: params["referenciaFuncionario"] = referencia_funcionario
        if tipo_relatorio is not None: params["tipoRelatorio"] = tipo_relatorio
        if ordenacao is not None: params["ordenacao"] = ordenacao
        if pdv is not None: params["pdv"] = pdv
        if premiacao_baseada_historico is not None: params["premiacaoBaseadaHistorico"] = premiacao_baseada_historico
        if apenas_comissionado is not None: params["apenasComissionado"] = apenas_comissionado
        if hora_inicial is not None: params["horaInicial"] = hora_inicial
        if hora_final is not None: params["horaFinal"] = hora_final
        if cliente is not None: params["cliente"] = cliente
        if apuracao is not None: params["apuracao"] = apuracao
        if filial is not None: params["filial"] = filial
